...
static void hmap_growth() {
    ...
    TEST_LCL_OK(lcl_hmap_insert( hmap, "Three", (lcl_any_t) 3, NULL, NULL ));
    TEST_LCL_OK(lcl_hmap_insert( hmap, "One", (lcl_any_t) 1, NULL, NULL ));
    TEST_LCL_OK(lcl_hmap_insert( hmap, "hundred", (lcl_any_t) 100, NULL, NULL ));
    TEST_LCL_OK(lcl_hmap_insert( hmap, "thousand", (lcl_any_t) 1000, NULL, NULL ));
    TEST_LCL_OK(lcl_hmap_insert( hmap, "million", (lcl_any_t) 1000000, NULL, NULL ));
    TEST_LCL_OK(lcl_hmap_insert( hmap, "billion", (lcl_any_t) 1000000000, NULL, NULL ));
